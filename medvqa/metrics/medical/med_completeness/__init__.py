...
class ConditionAwareWeightedMedicalCompleteness(WeightedMedicalCompletenessBase, ConditionAwareMetric):

    def __init__(self, tokenizer, output_transform, condition_function, record_scores=False):
        self._acc_score = 0
        self._count = 0
        self.record_scores = record_scores
        self.tokenizer = tokenizer
