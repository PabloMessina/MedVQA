...
if __name__ == '__main__':
    ...
    qa_adapted_reports_path = os.path.join(IUXRAY_CACHE_DIR, args.iuxray_qa_dataset_filename)
    ...
    output_path = os.path.join(IUXRAY_CACHE_DIR,
        f'medical_tags_per_report__from({args.iuxray_qa_dataset_filename})__{get_timestamp()}.pkl')
    save_to_pickle(output, output_path)
    print('IUXRAY medical tags per report computed and saved to', output_path)
