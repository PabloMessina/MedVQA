...
if __name__ == '__main__':
    ...
    processed_sentences_save_filepath = os.path.join(REXGRADIENT_160K_FAST_CACHE_DIR, args.api_type,
    ...
    if args.api_responses_filepath is None and args.batch_input_file_id is None:
        ...
        if args.only_special_sentences:
            ...
            regex = re.compile(
                ...
                # COVID-19 related
                r"covid|sars|coronavirus|\b19\b",
                re.IGNORECASE
            )
    ...
    run_common_boilerplate_for_api_requests(
        ...
        tmp_dir=REXGRADIENT_160K_FAST_TMP_DIR,
