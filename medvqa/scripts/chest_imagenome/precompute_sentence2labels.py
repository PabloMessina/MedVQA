...
if __name__ == '__main__':
    ...
    output_path = os.path.join(CHEST_IMAGENOME_CACHE_DIR, f'phrases2labels(num_obs={len(unique_observations)},num_anat={len(unique_anatomies)},num_phrases={len(phrases_o)}).pkl')
