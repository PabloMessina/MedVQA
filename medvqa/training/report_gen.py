...
def get_step_fn(model, optimizer, tokenizer, training, device,
    ...
    def step_fn__mimiccxr(batch):
        ...
        # # TODO: remove the following, just for debugging
        # assert predicted_binary_scores.shape == chexpert.shape
        # print('predicted_binary_scores', predicted_binary_scores)
        # print('chexpert', chexpert)
        # print('difference:', (predicted_binary_scores - chexpert.float()).abs().sum().item())
        # assert False
